...
public class Boss : Enemy
{
    ...
    private void Awake() 
    {
        ...
        Bounds bounds = AllServices.Container.Single<Bounds>();
        _minX += bounds.GetPaddingSides() * transform.localScale.x;
        _maxX -= bounds.GetPaddingSides() * transform.localScale.x;
